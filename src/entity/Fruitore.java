...
public class Fruitore extends Cittadino{
	...
	/**
	 * Costruttore classe Fruitore. Ciascun fruitore � composto da un nome, da una data
...
//	 * la possibilit� o meno di effettuare prestiti per la categoria libro.
//	 * @return
//	 */
//	public boolean controlloRichiestaPrestitoLibro(){
...
//	 * la possibilit� o meno di effettuare prestiti per la categoria film.
//	 * @return
//	 */
...
//	}
	...
	public List<Prestito> getPrestitiPerTipo(String tipoPrestito, List<Prestito> prestiti) {
		...
		for(Prestito p : prestiti) { //passo l'arrayList prestiti generico perch� cosi posso usarlo sia per prestiti storici che prestiti attuali
	 ...
	 * nell'elenco di prestiti dei fruitori, la scadenza.Se il prestito � scaduto, viene
	 * rimosso dall'elenco.
	 * @param d
