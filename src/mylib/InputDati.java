...
public class InputDati 
{
	  ...
	  public static int selezionaElementoDaArray(String[] lista){ //ci passo il mio array che ho nel model
			...
			int input = InputDati.leggiIntero(Constants.NUM_CATEGORIA, 1, lista.length);
			return input-1;
